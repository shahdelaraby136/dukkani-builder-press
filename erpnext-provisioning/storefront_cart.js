(function () {
  ...
  function installUI() {
    ...
    document.head.insertAdjacentHTML("beforeend", `<style>
      ...
      .sense-store-nav{background:#151817!important;border-top:3px solid #b40e35;border-bottom:1px solid #2e3331;color:#f4eee6!important;direction:ltr!important;display:block!important;font-family:Tajawal,Arial,sans-serif!important;padding:18px 2.2% 0!important;width:100%!important}
      .sense-store-nav-top{align-items:center;display:grid;gap:26px;grid-template-columns:auto minmax(300px,1fr) minmax(210px,auto);margin:0 auto;max-width:1580px;min-height:76px}
      .sense-store-account{color:#f4eee6;font:900 18px Tajawal,Arial,sans-serif;justify-self:start;text-decoration:none;white-space:nowrap}.sense-store-account:hover{color:#f54873}
      .sense-store-search{display:flex;min-width:0;width:100%}.sense-store-search button{align-items:center;background:#b40e35;border:0;color:#fff;cursor:pointer;display:flex;height:58px;justify-content:center;width:58px}.sense-store-search svg{height:28px;width:28px;stroke:currentColor}.sense-store-search input{background:#151817;border:1px solid #454a48;border-left:0;color:#f4eee6;direction:rtl;flex:1;font:500 18px Tajawal,Arial,sans-serif;height:58px;min-width:0;padding:0 22px;text-align:right}.sense-store-search input::placeholder{color:#b23a54;opacity:.9}
      .sense-store-logo{align-items:center;display:flex;gap:10px;justify-self:end;min-width:210px}.sense-store-logo img{display:block;max-height:64px;max-width:220px;object-fit:contain}
      .sense-store-links{align-items:center;display:flex;gap:36px;justify-content:flex-end;margin:0 auto;max-width:1580px;padding:24px 0 28px}.sense-store-links a{color:#f4eee6;font:900 18px Tajawal,Arial,sans-serif;text-decoration:none}.sense-store-links a:nth-child(n+2){color:#f54873}.sense-store-links a:hover{color:#fff}
